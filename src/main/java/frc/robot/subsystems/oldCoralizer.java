...
public class oldCoralizer extends SubsystemBase {
    ...
    public oldCoralizer() {
        ...
        intakeCurrentBelowThreshold = new Trigger(() -> ((intake.getSupplyCurrent().getValueAsDouble() < 3.0)
                && (intake.getSupplyCurrent().getValueAsDouble() > 0)));
    ...
    public Command intake() {
        return either(
                ...
                (runIntakeAndCoralizer(() -> 0.6).until(this::beamIsBroken)
                        ...
                        .andThen(
                                runIntakeAndCoralizer(() -> 0.4)
                                        .until(intakeCurrentBelowThreshold.and(this::beamNotBroken))
    ...
    public Command fastEjectCoral() {
        return runCoralizer(() -> 1).withTimeout(0.3).andThen(setDangerousToRaiseElevator())
                .andThen(setFirstBreakStateFalse());
    }
