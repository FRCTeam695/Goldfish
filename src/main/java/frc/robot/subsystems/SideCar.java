...
public class SideCar extends SubsystemBase{
    ...
    public int getScoringLevel(){
        int integerHeight = (int)scoringLevelSub.get(2);
        return integerHeight;
    }

    public Heights getScoringHeight(){
        int integerHeight = (int)scoringLevelSub.get(2);
